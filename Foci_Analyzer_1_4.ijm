...
#@ String (label = "Nuclei/cell segmentation method", choices={"StarDist nuclei segmentation (recommended)","Cellpose cytoplasm segmentation", "Classic nuclei segmentation"}, style="listBox") nucleiSegmentationChoice
